            ...
            <div class="row">
                <div class="column">
                    ...
                    <div class="form-group" id="mantenimiento-section" style="display: none;">
                        <label for="actividad-mantenimiento">Actividad de Mantenimiento:</label>
                        <textarea id="actividad-mantenimiento" name="actividad-mantenimiento"></textarea>
                    </div>
                    <div class="form-group" id="instalacion-section" style="display: none;">
                        <label for="actividad-instalacion">Actividad de Instalación:</label>
