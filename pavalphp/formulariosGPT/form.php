                ...
                <div class="column">
                    ...
                    <div id="facilitadores" class="hidden" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <select id="actividad" name="actividad">
                                ...
                                <option value="actividad1">Talleres</option>
                                <option value="actividad2">Capacitaciones</option>
                                <option value="actividad3">Asesorias</option>
                                <option value="actividad4">Conversatorios</option>
                                <option value="actividad5">Eventos</option>
                                <option value="actividad6">Trabajo administrativo</option>
                                <option value="actividad7">Actividades en promoción</option>
                    ...
                    <div id="colectivos" class="hidden" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <select id="acti" name="acti">
                                <option value="">--Seleccione una actividad--</option>
                                <option value="acti1">Visitas</option>
                                <option value="acti2">Talleres</option>
                                <option value="acti3">Asesorias</option>
                                <option value="acti">Comprobación de recursos</option>
                                <option value="acti">Otro</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
