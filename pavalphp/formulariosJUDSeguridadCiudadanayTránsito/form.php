...
<head>
    ...
    <link rel="stylesheet" href="../css/formSEJSeguri.css">
    <!-- Leaflet CSS -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const actividadDetalles = document.querySelectorAll('.actividad-detalles');
            
            selectActividad.addEventListener('change', function() {
                actividadDetalles.forEach(function(detalles) {
...
<body>  
    <div class="container">
        <form class="miFormulario" action="">
            <div class="row">
                <div class="column">
                    <h2 class="title">JUD de Seguridad Ciudadana y de Tránsito</h2>
                    <div class="form-group">
                        <label for="actividad">Actividad:</label>
                        <select id="actividad" name="actividad">
                            <option value="">Seleccione una actividad</option>
                            <option value="recorridos">Recorridos</option>
                            <option value="tripticos">Entrega de trípticos</option>
                            <option value="poblacionb">Población beneficiada</option>
                            <option value="calles">Calles liberadas de obstáculos</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="recorridos" class="actividad-detalles" style="display:none;">
                        <h3>Recorridos</h3>
                        <div class="form-group">
                            <label for="colonia">Colonia:</label>
                            <select id="colonia" name="colonia">
                        ...
                        <div class="form-group">
                            <label for="meta_recorridos">Meta:</label>
                            <input type="number" id="meta_recorridos" name="meta_recorridos">
                        </div>
                        <div class="form-group">
                            <label for="alcance_recorridos">Alcance mensual:</label>
                            <input type="number" id="alcance_recorridos" name="alcance_recorridos">
                        </div>
                        <div class="form-group">
                            <label for="avance_recorridos">Avance (%):</label>
                            <input type="number" id="avance_recorridos" name="avance_recorridos" readonly>
                        </div>
                    </div>

                    <div id="tripticos" class="actividad-detalles" style="display:none;">
                        <h3>Entrega de Trípticos</h3>
                        <div class="form-group">
                            <label for="meta_tripticos">Meta:</label>
                            <input type="number" id="meta_tripticos" name="meta_tripticos">
                        </div>
                        <div class="form-group">
                            <label for="alcance_tripticos">Alcance mensual:</label>
                            <input type="number" id="alcance_tripticos" name="alcance_tripticos">
                        </div>
                        <div class="form-group">
                            <label for="avance_tripticos">Avance (%):</label>
                            <input type="number" id="avance_tripticos" name="avance_tripticos" readonly>
                        </div>
                    </div>

                    <div id="poblacionb" class="actividad-detalles" style="display:none;">
                        <h3>Población Beneficiada</h3>
                        <div class="form-group">
                            <label for="meta_poblacionb">Meta:</label>
                            <input type="number" id="meta_poblacionb" name="meta_poblacionb">
                        </div>
                        <div class="form-group">
                            <label for="alcance_poblacionb">Alcance mensual:</label>
                            <input type="number" id="alcance_poblacionb" name="alcance_poblacionb">
                        </div>
                        <div class="form-group">
                            <label for="avance_poblacionb">Avance (%):</label>
                            <input type="number" id="avance_poblacionb" name="avance_poblacionb" readonly>
                        </div>
                    </div>

                    <div id="calles" class="actividad-detalles" style="display:none;">
                        <h3>Calles Liberadas de Obstáculos</h3>
                        <div class="form-group">
                            <label for="meta_calles">Meta:</label>
                            <input type="number" id="meta_calles" name="meta_calles">
                        </div>
                        <div class="form-group">
                            <label for="alcance_calles">Alcance mensual:</label>
                            <input type="number" id="alcance_calles" name="alcance_calles">
                        </div>
                        <div class="form-group">
                            <label for="avance_calles">Avance (%):</label>
                            <input type="number" id="alcance_calles" name="alcance_calles">
                        </div>
                    </div>
