    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() { 
            ...
            selectDimension.addEventListener('change', function() { 
                ...
                usuariosDiv.style.display = this.value === 'usuarios' ? 'block' : 'none'; 
            }); 
        });
    </script>
</head>
<body>
    <div class="container">
        <form class="miFormulario" action="">
            <div class="row">
                <div class="column">
                    <h2 class="title">Subdirección de Programas y Proyectos de Prevención del Delito</h2>
                    ...
                    <div id="facilitadores" class="hidden" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="espacio" name="espacio">
                        </div>
                        <div class="form-group">
                            <h3>Nombre del facilitador</h3>
                    ...
                    <div id="usuarios" class="hidden" style="display: none;">
                        <h3>Usuarios</h3>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <h3>Nombre de la persona usuaria</h3>
                            <label for="nombref">Nombre:</label>
                            <input type="text" id="nombref" name="nombref" required>
                        </div>
                        <div class="form-group">
