...
<head>
    ...
    <title>Fortalecimiento para el cuidado y desarrollo integral de las infancias</title>
                ...
                <div class="column">
                    ...
                    <div class="form-group">
                        ...
                        <select id="actividad" name="actividad">
                            ...
                            <option value="actividad1">Jornadas de salud</option>
                            <option value="actividad2">Capacitaciones</option>
                            <option value="actividad3">Conversatorios</option>
                            <option value="actividad4">Rehabilitación</option>
                        </select>
                    </div>
                    <div class="form-group">
